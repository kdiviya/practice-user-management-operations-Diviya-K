...
-- Task1 GROUP BY queries with aggregate functions like SUM and COUNT

SELECT customer_id, SUM(total_amount) AS total_spent
FROM orders
GROUP BY customer_id;

SELECT customer_id, COUNT(*) AS No_of_Customers
FROM orders
GROUP BY customer_id; 

-- Task2: Apply WHERE and HAVING clauses to filter data
...
-- Task4: Practice using SubQueries to create dynamic filters
